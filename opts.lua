...
function M.parse(arg)
   ...
   ---------- Model options ----------------------------------
   cmd:option('-netType',      'resnetdpp', 'Options: resnet | resnetdpp')
   cmd:option('-depth',        110,       'ResNet depth: 18 | 34 | 50 | 101 | ...', 'number')
   cmd:option('-poolingType', 'DPP_sym_lite',       'Options: DPP_sym_lite | DPP_asym_lite | DPP_sym_full | DPP_asym_full')
   cmd:option('-stochasticity', 'false',       'with or without stochasticity')
